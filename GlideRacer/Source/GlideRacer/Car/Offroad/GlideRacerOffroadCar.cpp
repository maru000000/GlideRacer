...
#include "GlideRacerOffroadCar.h"
#include "GlideRacerOffroadWheelFront.h"
#include "GlideRacerOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AGlideRacerOffroadCar::AGlideRacerOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGlideRacerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGlideRacerOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGlideRacerOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGlideRacerOffroadWheelRear::StaticClass();
...
void AGlideRacerOffroadCar::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);
	PlayerInputComponent->BindAction("Drift", IE_Pressed, this, &AGlideRacerOffroadCar::StartDrift);
	PlayerInputComponent->BindAction("Drift", IE_Released, this, &AGlideRacerOffroadCar::StopDrift);
}

void AGlideRacerOffroadCar::StartDrift()
{
	UE_LOG(LogTemp, Warning, TEXT("🚗 Start Drift!"));
	UpdateWheelFriction(true);
}

void AGlideRacerOffroadCar::StopDrift()
{
	UE_LOG(LogTemp, Warning, TEXT("🛑 Stop Drift!"));
	UpdateWheelFriction(false);
}

void AGlideRacerOffroadCar::Tick(float DeltaTime)
{
...
void AGlideRacerOffroadCar::UpdateWheelFriction(bool bDrift)
{
